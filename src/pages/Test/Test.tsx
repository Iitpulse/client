...
const Test = () => {
  ...
  const columns = [
    ...
    {
      title:'Actions',
      render: (row:any)=> <Button onClick={()=>navigate("/test/result/"+row.id)} >View Result</Button>
    }
  ];
  ...
  const [data, setData] = useState<any>([{id:1,name:'Sample Test',exam:{fullName:'JEE MAINS'},createdAt:'22/01/2032',status:'Ongoing'}]);
